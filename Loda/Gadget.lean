...
lemma two_mul_int
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v) (Expr.intExpr (Expr.var x) IntegerOp.add (Expr.var x)))))
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v) (Expr.intExpr (Expr.constInt 2) IntegerOp.mul (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
  obtain ⟨vv, hv_eq⟩ : ∃ vv, Eval.eval σ Δ (Expr.var "v") = some (Value.vInt vv) := by
...
lemma two_mul_field {p: ℕ}
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var x) FieldOp.add (Expr.var x)))))
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.constF p 2) FieldOp.mul (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
  obtain ⟨vv, hv_eq⟩ : ∃ vv, Eval.eval σ Δ (Expr.var "v") = some (Value.vF p vv) := by
...
lemma add_comm_int
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.var x) IntegerOp.add (Expr.var y)))))
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.var y) IntegerOp.add (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma add_comm_field {p: ℕ}
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var x) FieldOp.add (Expr.var y)))))
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var y) FieldOp.add (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma bool_and_comm
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin Ty.bool (fun v => exprEq (Expr.var v)  (Expr.boolExpr (Expr.var x) BooleanOp.and (Expr.var y)))))
      (pure (Ty.refin Ty.bool (fun v => exprEq (Expr.var v)  (Expr.boolExpr (Expr.var y) BooleanOp.and (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
  obtain ⟨vv, hv_eq⟩ : ∃ vv, Eval.eval σ Δ (Expr.var "v") = some (Value.vBool vv) := by
...
lemma mul_comm_int
  ...
  (Γ: Env.TyEnv) (x y: String) (xv xu: ℤ) (hσx : Env.lookupVal σ x = Value.vInt xv) (hσy : Env.lookupVal σ y = Value.vInt xu)
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.var x) IntegerOp.mul (Expr.var y)))))
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.var y) IntegerOp.mul (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma mul_comm_field {p: ℕ}
  ...
  (Γ: Env.TyEnv) (x y: String) (xv xu: ℕ) (hσx : Env.lookupVal σ x = Value.vF p xv) (hσy : Env.lookupVal σ y = Value.vF p xu)
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var x) FieldOp.mul (Expr.var y)))))
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var y) FieldOp.mul (Expr.var x)))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma add_assoc_int
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.intExpr (Expr.var x) IntegerOp.add (Expr.var y)) IntegerOp.mul (Expr.var z)))))
      (pure (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.intExpr (Expr.var x) IntegerOp.mul (Expr.var z)) IntegerOp.add (Expr.intExpr (Expr.var y) IntegerOp.mul (Expr.var z))))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma mul_one_field {p: ℕ}
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var x) FieldOp.mul (Expr.constF p 1)))))
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.var x))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma add_zero_field {p: ℕ}
  ...
  (x: String) (xv: ℕ) (hσx : Env.lookupVal σ x = Value.vF p xv)
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var x) FieldOp.add (Expr.constF p 0)))))
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.var x))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
...
lemma mul_inv_field {p: ℕ}
  ...
  : @Ty.SubtypeJudgment σ Δ Γ
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.fieldExpr (Expr.var x) FieldOp.mul (Expr.fieldExpr (Expr.constF p 1) FieldOp.div (Expr.var x))))))
      (pure (Ty.refin (Ty.field p) (fun v => exprEq (Expr.var v)  (Expr.constF p 1))))
  := by
  apply Ty.SubtypeJudgment.TSub_Refine
  · apply Ty.SubtypeJudgment.TSub_Refl
  intro h
...
lemma typed_int_expr_from_refined_vars
  ...
  : @Ty.TypeJudgment σ Δ Γ (Ast.Expr.intExpr (Ast.Expr.var x) op (Ast.Expr.var y))
      (Ty.refin Ty.int (fun v => exprEq (Expr.var v)  (Expr.intExpr (Expr.var x) op (Expr.var y)))) := by
...
lemma int_refintype_implies_exists_int_value (σ: Env.ValEnv) (Δ: Env.CircuitEnv) (Γ: Env.TyEnv) (x: String) (e: String → Expr)
